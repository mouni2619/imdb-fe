...
function Movies() {
  ...
  const getMovies = async () => {
    const res = await fetch(`${process.env.REACT_APP_API_LINK}/movie/all`, {
      method: "GET",
      headers: {
  ...
  const getActors = async () => {
    const res = await fetch(`${process.env.REACT_APP_API_LINK}/cast/actors`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const getProducers = async () => {
    const res = await fetch(
      `${process.env.REACT_APP_API_LINK}/cast/producers`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
